...
public enum EPDSearchField implements IHasID <String>, IHasDisplayText
{
  ...
  PARTICIPANT_ID ("participant",
                  ...
                  sQuery -> PDQueryManager.getParticipantIDLuceneQuery (sQuery)),
  NAME ("name",
  ...
  COUNTRY ("country",
           ...
           ESearchDataType.STRING_CI,
           Locale.class,
           sQuery -> PDQueryManager.getCountryCodeLuceneQuery (sQuery)),
  GEO_INFO ("geoinfo",
  ...
  IDENTIFIER_SCHEME ("identifierScheme",
                     ...
                     ESearchDataType.STRING_CS,
                     String.class,
                     sQuery -> PDQueryManager.getIdentifierSchemeLuceneQuery (sQuery)),
  IDENTIFIER_VALUE ("identifierValue",
                    EPDSearchFieldName.IDENTIFIER,
                    ESearchDataType.STRING_CS,
                    String.class,
                    sQuery -> PDQueryManager.getIdentifierValueLuceneQuery (sQuery)),
  WEBSITE ("website",
           EPDSearchFieldName.WEBSITE,
           ESearchDataType.STRING_CI,
           String.class,
           sQuery -> PDQueryManager.getWebsiteLuceneQuery (sQuery)),
  CONTACT ("contact",
           EPDSearchFieldName.CONTACT,
           ESearchDataType.STRING_CI,
           String.class,
           sQuery -> PDQueryManager.getContactLuceneQuery (sQuery)),
  ...
  REGISTRATION_DATE ("regdate",
                     ...
                     LocalDate.class,
                     sQuery -> PDQueryManager.getRegistrationDateLuceneQuery (sQuery)),
  DOCUMENT_TYPE ("doctype",
                 EPDSearchFieldName.DOCUMENT_TYPE,
                 ESearchDataType.STRING_CS,
                 IDocumentTypeIdentifier.class,
                 sQuery -> PDQueryManager.getDocumentTypeIDLuceneQuery (sQuery));
