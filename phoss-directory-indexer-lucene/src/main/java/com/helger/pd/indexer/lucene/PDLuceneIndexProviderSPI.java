...
/**
 * The {@link IPDIndexProviderSPI} implementation for the local Apache Lucene index. This is the
 * default search index of the Peppol Directory.
 *
 * @author Philip Helger
 * @since 0.16.0
 */
@IsSPIImplementation
public class PDLuceneIndexProviderSPI implements IPDIndexProviderSPI
{
  /** The ID of this search index type - to be used in the configuration */
  public static final String INDEX_TYPE_ID = "lucene";
