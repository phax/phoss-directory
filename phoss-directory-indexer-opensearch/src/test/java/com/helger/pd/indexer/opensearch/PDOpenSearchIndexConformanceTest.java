...
import com.helger.pd.indexer.conformance.AbstractPDIndexConformanceTest;
import com.helger.pd.indexer.conformance.PDIndexerTestRule;
import com.helger.pd.indexer.searchindex.IPDIndex;

/**
 * The search index conformance test for {@link PDOpenSearchIndex}. It is skipped if no OpenSearch
 * is reachable at {@link PDOpenSearchTestHelper#ENDPOINT_URL} - see <code>docs/opensearch.md</code>
 * for the Docker command line that starts a matching OpenSearch instance.
 *
 * @author Philip Helger
 */
public final class PDOpenSearchIndexConformanceTest extends AbstractPDIndexConformanceTest
{
  @Rule
